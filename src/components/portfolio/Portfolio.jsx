    ...
    <div className="col-12 portfolio_inner my_carousel gallery_zoom">
      ...
      <Box sx={{ width: '100%', typography: 'body1' }}>
        <TabContext value={value}>
          <Box sx={{ borderBottom: 0, borderColor: 'red' }}>
            <TabList 
              onChange={handleChange} aria-label="" 
              TabIndicatorProps={
                {style: {backgroundColor: "#bf2054"} , sx: { display: 'none' } }
              }
              sx={{
            ...
            >
              <Tab label="All" value="0" className="tabs_portfolio" />
              <Tab label="ReactJS" value="1" className="tabs_portfolio" />
              <Tab label="PHP" value="2" className="tabs_portfolio" />
              <Tab label="Ecommerce" value="3" className="tabs_portfolio" />
            </TabList>
          </Box>
          <TabPanel value="0" className="tabpanel_portfolio">
